    ...
    <div className="max-w-3xl mx-auto px-4 pt-4 pb-8">
      ...
      {state === "ok" && data && (
        <>
          ...
          <h1 className="text-xl font-bold mb-1">{data.department}</h1>
          <p className="text-sm text-[var(--c-ink-2)] mb-4">{data.labs.length}研究室を、分野・研究テーマから比較できます。</p>
          ...
          <div className="mt-6 bg-[var(--c-surface)] rounded-[var(--radius-panel)] p-4 text-sm text-[var(--c-ink-2)]">
            この専攻の研究室ページをまとめて整備・比較しやすくする「研究室コンパス」の導入は、<Link to="/for-labs" className="text-[var(--c-teal)] font-bold underline">運営者向けページ</Link>からご相談ください。
          </div>
        </>
      )}
    </div>
